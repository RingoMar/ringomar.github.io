...
export default function NavBar() {
  return (
    <nav className="start-0 top-0 z-20 w-full border-b border-gray-200 bg-white dark:border-slate-600 dark:bg-slate-800">
      ...
      <span className="absolute rounded-full w-full h-1 bg-blue-500 opacity-40 blur-md"></span>
    </nav>
  );
}
