      ...
      <div className="mx-auto flex max-w-screen-xl justify-between px-4">
        <article className="format format-sm sm:format-base lg:format-lg format-blue dark:format-invert mx-auto w-full max-w-2xl">
          <header className="not-format mb-4 lg:mb-6">
            <h1 className="mb-6 text-4xl font-bold text-gray-800 md:text-5xl dark:text-gray-200">The Timekeeper</h1>
            <time dateTime="2024-04-08" title="May 8th, 2024" className="text-gray-600 dark:text-gray-200">
              8 May, 2024
            </time>
            <div className="mt-4 flex gap-1">
              <Link href="https://timekeeper.ringomar.com" prefetch className="inline-flex cursor-pointer items-center gap-1 rounded-lg bg-blue-500 px-5 py-3 text-center text-base font-medium text-white hover:bg-blue-600 focus:ring-4 focus:ring-blue-500 focus:outline-none dark:bg-blue-500 dark:hover:bg-blue-600">
                <OutLink />
                Documentation
              </Link>
              <Link href="https://timer.ringomar.com" prefetch className="inline-flex cursor-pointer items-center gap-1 rounded-lg bg-blue-500 px-5 py-3 text-center text-base font-medium text-white hover:bg-blue-600 focus:ring-4 focus:ring-blue-500 focus:outline-none dark:bg-blue-500 dark:hover:bg-blue-600">
                <OutLink />
                Preview
              </Link>
            </div>
          ...
          <section className="mb-5">
            <p className="mb-4 text-gray-600 dark:text-gray-200">This is a simple web application that displays the elapsed time since a specified timestamp. It can be useful for tracking how much time has passed since a particular event or milestone.</p>
            ...
            <h2 className="mb-4 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-gray-200">How it works</h2>
            <div className="mb-4 text-gray-600 dark:text-gray-200">
              ...
              <h2 className="mb-4 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-gray-200" id="showcase">
              ...
              <h2 className="mb-4 text-2xl font-semibold text-gray-800 md:text-3xl dark:text-gray-200" id="recognition">
